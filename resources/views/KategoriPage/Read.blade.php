...
<main class="container py-4">
    ...
    <div class="card kategori-card">
        <div class="kategori-card-header">
            ...
            <button class="btn btn-add-kategori text-white"
        ...
        <form id="formAddKategori" class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title">
                    <i class="bi bi-plus-circle me-2 opacity-75"></i>Add New Group
                </h5>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" id="add_nama" class="form-control"
                           placeholder="e.g. IT Development" required>
                </div>
                <div class="mb-0">
                    ...
                    <textarea id="add_deskripsi" class="form-control" rows="3"
...
<div class="modal fade" id="modalEditKategori" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form id="formEditKategori" class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title">
                    <i class="bi bi-pencil-square me-2 opacity-75"></i>Edit Group
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
